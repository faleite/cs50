...
bool check(char* word)
{
    /*definindo um node ponteiro, cursor para root o trie.*/
    node *cursor = root;

    int index = 0;
    char* tword = word;

    /*Percorra todas as letras do argumento word e, ao fazer isso,
    determine o índice da matriz que corresponde a essa letra.*/
